...
const MediaDepartment = () => {
    ...
    return (
        <div className="media-department-content-wrapper">
            <section className="media-deparment-slide" style={{ overflow: "visible", position: "relative" }}>

                <Slider {...settings}>
                    {images.map((img, index) => (
                        <div key={index}>
                            <div
                                className="media-department-slide"
                                style={{
            ...
            <div className="media-department-text">
                <p>
            ...
            <h1>Want to join media Team? Fill out the form</h1>

            <form className="media-department-custom-form">
                ...
                <label htmlFor="comment">Comment <span className="media-option-label">(optional)</span></label>
