...
const WorshipDepartment = () => {
    ...
    return (
        <div className="worship-department-content-wrapper">
            <section className="worship-deparment-slide" style={{ overflow: "visible", position: "relative" }}>
                <Slider {...settings}>
                    {images.map((img, index) => (
                        <div key={index}>
                            <div
                                className="worship-department-img-slide"
                                style={{
            ...
            <div className='worship-department-title'>
                Worship Department
            </div>
            <div className="worship-department-text">
                <p>
            ...
            <h1>Want to join worship Team? Fill out the form</h1>

            <form className="worship-department-custom-form">
                ...
                <label htmlFor="comment">Comment <span className="worship-option-label">(optional)</span></label>
...
export default WorshipDepartment;
