...
const FamilyDepartment = () => {
    ...
    return (
        <div className="family-department-content-wrapper">
            <section className="family-deparment-slide" style={{ overflow: "visible", position: "relative" }}>
                <Slider {...settings}>
                    {images.map((img, index) => (
                        <div key={index}>
                            <div
                                className="family-department-slide"
                                style={{
            ...
            <div className="family-department-text">
                <p>
            ...
            <h1>Want to join family Team? Fill out the form</h1>

            <form className="family-department-custom-form">
                ...
                <label htmlFor="comment">Comment <span className="family-option-label">(optional)</span></label>
...
export default FamilyDepartment;
